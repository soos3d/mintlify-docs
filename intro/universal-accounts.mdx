...
Universal Accounts are smart contract accounts powered by Particle Network's [Universal Liquidity](/landing/modular-l1/universal-liquidity) technology, enabling seamless cross-chain transactions and interactions.
...
3. **Integration**
   ...
   - Works with [Modular Smart Wallet-as-a-Service](/landing/wallet-abstraction/waas/overview)
