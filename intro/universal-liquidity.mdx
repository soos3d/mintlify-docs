...
Particle Network’s Universal Liquidity functionality acts as the underlying layer enabling seamless, atomic cross-chain interactions, enabling the unification of balances within [Universal Accounts](/intro/universal-accounts).
